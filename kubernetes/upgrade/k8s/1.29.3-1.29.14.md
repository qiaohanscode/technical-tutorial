...
sudo apt-get update && sudo apt-get install -y kubeadm='1.29.14-1.1' && \
...
```
sudo kubeadm upgrade apply v1.29.14
```
...
sudo apt-get update && sudo apt-get install -y kubelet='1.29.14-1.1' kubectl='1.29.14-1.1' && \
