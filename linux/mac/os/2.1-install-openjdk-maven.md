...
echo "export PATH=/Users/qiao.han/Han/applications/maven/apache-maven-3.9.8/bin:$PATH" >>~/.zprofile
...
```
sudo keytool -importcert -alias CaCert -file cacert.cer \
 -cacerts /Library/Java/JavaVirtualMachines/openjdk-17.jdk/Contents/Home/lib/security/cacerts \
 -storepass changeit
```